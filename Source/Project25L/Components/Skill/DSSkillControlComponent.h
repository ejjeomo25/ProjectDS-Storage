 ...
 */
	...
	FDSSkillSpec* FindSkillSpecFromType(ESkillType Handle) const;
...
protected:
	...
	*/
	...
	/** This is a list of Skills that were activated on the server and can't yet execute on the client. It will try to execute these at a later point */
