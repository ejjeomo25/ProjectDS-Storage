...
struct FDSFadedActorInfo
{
	GENERATED_USTRUCT_BODY()
public:
	FDSFadedActorInfo() : bIsFaded(false), MaterialInstance(nullptr) { }
	FDSFadedActorInfo(UMaterialInstanceDynamic* CreatedMaterial) : bIsFaded(false), MaterialInstance(CreatedMaterial) {}
...
protected:
	...
	void FadeObstructingActors();
protected:
	
	UPROPERTY(Transient)
	TMap<TObjectPtr<AActor>, FDSFadedActorInfo> FadedActors;
