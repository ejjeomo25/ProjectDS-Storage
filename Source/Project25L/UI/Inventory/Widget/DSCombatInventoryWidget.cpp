...
void UDSCombatInventoryWidget::InitInventoryWidget()
{
	...
	{
		FPersonalInventoryInfo* InventoryInfo = InventoryComponent->GetInventoryInfo(EInventoryCategory::PersonalItem);
		TArray<FDSItemInfo>* PersonalItemInventory = InventoryComponent->GetInventoryArray(EInventoryCategory::PersonalItem);
		PersonalItemInventoryWidget->Init(EInventoryCategory::PersonalItem, InventoryInfo, PersonalItemInventory, InventoryComponent);
	}


	if (IsValid(PersonalVehicleInventoryWidget))
	{
		FPersonalInventoryInfo* InventoryInfo = InventoryComponent->GetInventoryInfo(EInventoryCategory::PersonalVehicle);
		TArray<FDSItemInfo>* PersonalItemInventory = InventoryComponent->GetInventoryArray(EInventoryCategory::PersonalVehicle);
		PersonalVehicleInventoryWidget->Init(EInventoryCategory::PersonalVehicle, InventoryInfo, PersonalItemInventory, InventoryComponent);
	}
